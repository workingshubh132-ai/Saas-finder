...
export const CUSTOMER_SIGNAL_ELIGIBLE_CLAIM_TYPES: Readonly<Partial<Record<CustomerSignalType, readonly ClaimType[]>>> = {
  ...
  WORKFLOW: ["CUSTOMER_PROBLEM"],
  VOLUME: ["CUSTOMER_PROBLEM", "ECONOMICS"],
  TIME_COST: ["ECONOMICS"],
  CONSEQUENCE: ["CUSTOMER_PROBLEM", "ECONOMICS"],
  AUTOMATION_ATTEMPT: ["COMPETITIVE_POSITION", "DIFFERENTIATION"],
};
